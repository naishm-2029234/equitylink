  ...
  return (
    ...
    <div className="App">
      ...
      <div className="about-us">
        ...
        <p>Within our site, users will discover an array of tools tailored for individuals looking to implement digital literacy programs. We included features such as an interactive map highlighting crucial infrastructures like libraries and nearby nonprofit organization offices, budgeting tips, and workshops aimed at enhancing leadership skills. While certain features, such as our interactive map, are specific to the Tri-Cities area, we strive to provide valuable information for all users navigating the realm of digital literacy. It's important to note that our project is ongoing, with continual updates and improvements underway.</p>
